...
class UsersController extends AppController
{
 ...
 // clear previous user input, since each Captcha code can only be validated once
    ...
    public function forgot(){
        ...
        try {
            $res = $email->from('xerxes.break786@gmail.com')
                  ->to($this->request->data['email'])
                  ->subject('Contact')
                  ->send('Se recibió tu peticion, alguien te contactará hasta en 24 horas. Gracias. SekaiEntertainment  PD: Debimos escoger a la chica >:v xdxd');
