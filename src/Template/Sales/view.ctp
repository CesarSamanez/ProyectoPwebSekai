      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <dd><?= $sale->has('user') ? $this->Html->link($sale->user->name." ".$sale->user->last_name, ['controller' => 'Users', 'action' => 'view', $sale->user->id]) : '' ?></dd>
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <?php endforeach; ?>
                 <tr>
              <?php $subtotal=($sale->total)*100/118; ?>
              <td></td> <td>SIN-IGV</td> <td></td> <td> <?php echo $subtotal; ?></td>
              </tr>
              <tr>
              <td></td> <td>IGV</td> <td></td> <td> <?php echo ($sale->total)-$subtotal; ?></td>
              </tr>
              <tr>
              <td></td> <td>TOTAL</td> <td></td> <td> <?php echo $sale->total; ?></td>
              </tr>
            </tbody>
          </table>
</div>
